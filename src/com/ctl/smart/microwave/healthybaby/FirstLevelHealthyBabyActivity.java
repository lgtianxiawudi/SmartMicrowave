package com.ctl.smart.microwave.healthybaby;
...
import com.ctl.smart.microwave.ferment.FermentingActivity;
...
public class FirstLevelHealthyBabyActivity extends AbActivity implements
		OnClickListener {
				...
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						adapter=new FancyCoverFlowSampleAdapter(
										item,
										FirstLevelHealthyBabyActivity.this,
								width, height);
						fancyCoverFlow
								.setAdapter(adapter);
