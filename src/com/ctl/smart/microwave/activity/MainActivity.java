...
import com.ctl.smart.microwave.service.MicroWaveService;
...
public class MainActivity extends AbActivity implements TimeChangeListener,OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent localIntent = new Intent(this, MicroWaveService.class);
        if (startService(localIntent) == null)
	    System.out.println("Error: Cannot start service");
...
//			StartActivityUtil.startActivityForResult(this, SystemSettings.class);
   ...
   private MicroWaveService mService;
   private final ServiceConnection mServiceConnection = new ServiceConnection()
   {
      public void onServiceConnected(ComponentName paramComponentName, IBinder paramIBinder)
      {
         mService=((MicroWaveService.ServiceBinder)paramIBinder).getService();
         Log.e("lwxdebug", "mServiceConnection oncreat0");
        if (mService == null)
         finish();
        if (!mService.isServiceInit())
        {
          Log.e("lwxdebug", "mServiceConnection oncreat");
        }
    }
    public void onServiceDisconnected(ComponentName paramComponentName)
    {
          System.out.println("onServiceDisconnected className = " + paramComponentName);
    }
  };
	...
	switch(keyCode)
	{
      case KeyEvent.KEYCODE_1: //zengqi
          item=getResources().getStringArray(R.array.reheart_level1);
			...
			StartActivityUtil.startActivityForResult(this,
					SecondLevelReHeartActivity.class, bundle2);
      ...
      case KeyEvent.KEYCODE_2://weibobianp
        item=getResources().getStringArray(R.array.reheart_level1);
			...
			StartActivityUtil.startActivityForResult(this,
					SecondLevelReHeartActivity.class, bundle3);
	  ...
	  case KeyEvent.KEYCODE_3:
			...
			StartActivityUtil.startActivityForResult(this,
					SecondLevelReHeartActivity.class, bundle1);
