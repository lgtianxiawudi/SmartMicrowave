...
public class ThreeCavitycleanActivity extends AbActivity implements CurrentPercent,onChangeStaueListener {
	String name="";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		.setBackListener().setAutoPlayListener(time, CavitycleanFinishActivity.class, name).setCurrentPercent(this);

	    bottomUtilThree.setChangeStaue(this);
		HeadUtil headUtil=new HeadUtil(this).setTitleName(name);
		Log.e("lwxdebug", " ThreeCavitycleanActivity=");
