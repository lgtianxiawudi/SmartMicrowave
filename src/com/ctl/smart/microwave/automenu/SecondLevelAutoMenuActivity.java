...
public class SecondLevelAutoMenuActivity extends AbActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        this.fancyCoverFlow.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				adapter=new FancyCoverFlowSampleAdapter(item,SecondLevelAutoMenuActivity.this,width,height);
	...
	private void itemListener() {
		...
		StartActivityUtil.startActivityOther(this,ThirdLevelAutoMenuActivity.class,null,item[position],key,position,item[position],1);
	}
	@Override
