...
public class SecondLevelFermentActivity extends AbActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null) {
			...
			item = getResources().getStringArray(R.array.snacks_level2);
		}
				...
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						adapter = new FancyCoverFlowSampleAdapter(
								item, SecondLevelFermentActivity.this,
								width, height);
