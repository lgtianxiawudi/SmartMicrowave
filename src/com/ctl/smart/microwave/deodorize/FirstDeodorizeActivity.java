...
public class FirstDeodorizeActivity extends AbActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		name=getString(R.string.taste_removal);
		bottomUtilThree = new BottomUtilOne(this)
		.setBackListener().setTime(60*1000);
	...
	private class MyCountDownTimer  extends CountDownTimer{
		...
		public void onFinish() {
			...
			StartActivityUtil.startActivityForResult(FirstDeodorizeActivity.this, SecondDeodorizeActivity.class,bundle);
		}
	}
	@Override
