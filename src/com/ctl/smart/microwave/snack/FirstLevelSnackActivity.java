package com.ctl.smart.microwave.snack;
...
public class FirstLevelSnackActivity extends AbActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle back_maindInstanceState) {
		...
		ImageId = new int[] { R.drawable.image22, R.drawable.image23,
				R.drawable.image24, R.drawable.image25, R.drawable.image26,
				R.drawable.image082406, R.drawable.image082407,
				R.drawable.image082408, R.drawable.image082409,
				R.drawable.image082410, R.drawable.image082411 };
					...
					public void onGlobalLayout() {
						...
						fancyCoverFlow
								.setAdapter(new FancyCoverFlowSampleAdapter(
										item,
										FirstLevelSnackActivity.this, width,
										height));
