...
public class MyProgress extends ProgressBar {
	...
	protected void onDraw(Canvas canvas) {
		...
		int pad = mBorderWidth / 18;
		// 画圆形图像
		Bitmap roundBitmap = getCroppedRoundBitmap(bitmap, radius - pad);
		// canvas.drawCircle(mBorderWidth/2 - radius+pad,
		// mBorderHeight/2 - radius+pad, radius, paint);
		canvas.drawBitmap(roundBitmap, mBorderWidth / 2 - radius + pad,
				mBorderHeight / 2 - radius + pad, paint);
	}
	...
	public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
		...
		canvas.drawCircle(scaledSrcBmp.getWidth() / 2,
				scaledSrcBmp.getHeight() / 2, radius, paint);
